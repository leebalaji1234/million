        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbar-ex-collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li {if $pagename == ''} class="active"{/if}>
              ...
              {if $app->setting->user_accounts}
                ...
                <li {if $pagename == 'account'} class="active" {/if}> <a href="{url|escape href='/account.php'}"><!-- Welcome,  {$smarty.session.first_name} {$smarty.session.last_name} --> My Profile</a>
                </li>
               <!--  <li>
              ...
              {else}
                <li {if $pagename == 'login'} class="active" {/if}><a href="{url|escape href='/login.php'}">##Log In##</a> </li>
                
                <li {if $pagename == 'register'} class="active" {/if}><a href="{url|escape href='/signup.php'}">##Register##</a></li>
