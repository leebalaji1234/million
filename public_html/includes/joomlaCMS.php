...
$joomla_root_path = 'D:/web/common/joomla/';
...
$GLOBALS['mainframe'] =& new mosMainFrame( $GLOBALS['database'], "", $GLOBALS['joomla_root_path']);
...
if (isset($GLOBALS['fc_config']) && isset($GLOBALS['fc_config']['languages'])) {
