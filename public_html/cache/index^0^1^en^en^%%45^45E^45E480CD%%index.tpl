263
a:4:{s:8:"template";a:6:{s:9:"index.tpl";b:1;s:12:"html.inc.tpl";b:1;s:15:"toolbar.inc.tpl";b:1;s:14:"header.inc.tpl";b:1;s:18:"wz_tooltip.inc.tpl";b:1;s:14:"footer.inc.tpl";b:1;}s:9:"timestamp";i:1467227378;s:7:"expires";i:1467230978;s:13:"cache_serials";a:0:{}}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<!-- Pixels Sold: 46,700 Available: 953,300&nbsp;&nbsp; -->
...
<!-- pixel board starts here -->
  <div class="col-md-10 pixelboard" style="padding-right:0px !important ;">
	  ...
	  <map name="grid_2"><area shape="rect" coords="260,160,340,240" href="?r=1" target="_blank"onclick="window.open('?r=1','_blank');return false;" alt="sdfdsf" title="sdfsd"  onmouseover="return escape('sdfsd');"  /><area shape="rect" coords="450,110,640,300" href="?r=2" target="_blank"onclick="window.open('?r=2','_blank');return false;" alt="start" title="start"  onmouseover="return escape('start');"  /><area shape="rect" coords="70,40,140,100" href="?r=3" target="_blank"onclick="window.open('?r=3','_blank');return false;" alt="sdflsdf" title="asdasda"  onmouseover="return escape('asdasda');"  /></map>
    <!-- float: left -->
	<div style="" ><img  width="100%" src="http://localhost/gp/public_html/grids/grid_2.png?x=1467227378" usemap="#grid_2"   alt="" border="0" /></div><div style="clear: both"></div>

  <!--  <div style="float: left"><img   src="http://localhost/gp/public_html/grids/grid_2.png?x=1467227378" usemap="#grid_2" width="1000" height="1000" alt="" border="0" /></div><div style="clear: both"></div> --> 
...
<div class="col-md-2  feedswidget" style="padding-left:0px;">
  <div class="panel panel-primary"  style="height:1084px;overflow-y:auto;">
        ...
        <div class="row">
           ...
           <a href="drawing.php?id=21"> <img src="images/drawings/1463552910.png" class="center-block img-circle img-responsive" style="height:60px;" >
            ...
            <!-- <p class="text-center">View</a></p> -->
                    ...
                    <div class="col-md-2">
           <a href="drawing.php?id=24"> <img src="images/drawings/balaji1_arumugam_United States_Tamil Nadu_Chennai_workoo1466197730.png" class="center-block img-circle img-responsive" style="height:60px;" >
            <h3 class="text-center">workoo</h3>
          </a>
            <!-- <p class="text-center">View</a></p> -->
          </div> 
                  </div>
 ...
 <!-- top sponsors starts here -->
      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <img src="http://localhost/gp/public_html/session_image.php?x=1467227378&r=2"  class="center-block img-circle img-responsive" class="center-block img-circle img-responsive"/>
            ...
            <img src="http://localhost/gp/public_html/session_image.php?x=1467227378&r=1"  class="center-block img-circle img-responsive" class="center-block img-circle img-responsive"/>
            <h3 class="text-center">sdfsd</h3>
 ...
 <!-- top volunteers starts here -->
      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <h3 class="text-center">balaji</h3>
             <p class="text-center">MDD1</p> 
          </div> 
                  </div>
     </div>
...
<script type="text/javascript" src="http://localhost/gp/public_html/wz_tooltip.js"></script>
