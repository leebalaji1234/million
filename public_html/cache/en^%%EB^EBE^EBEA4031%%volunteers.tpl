239
a:4:{s:8:"template";a:5:{s:14:"volunteers.tpl";b:1;s:12:"html.inc.tpl";b:1;s:15:"toolbar.inc.tpl";b:1;s:14:"header.inc.tpl";b:1;s:14:"footer.inc.tpl";b:1;}s:9:"timestamp";i:1467231391;s:7:"expires";i:1467234991;s:13:"cache_serials";a:0:{}}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-5"> 
                     <select name="city" id="city" class="form-control" onchange="citySelect(this.value);"> 
                       ...
                       <option value="addnew"  >Add city</option> 
                          
                      </select>
                      <span id="citymanualoption" > </span>
                    </div>
                  </div> -->
                    ...
                    <div class="col-sm-5 col-sm-offset-2 well"> 
                     ...
                     <img id="captcha" src="http://localhost/gp/public_html/captcha_image.php?x=1467231391" style="vertical-align: middle;border-radius:20px;border:2px solid grey;" alt="CAPTCHA Image" /> <i class="fa fa-2x fa-refresh" style="margin-left:10px;" onclick="CaptchaRefresh();"></i>
