235
a:4:{s:8:"template";a:5:{s:10:"signup.tpl";b:1;s:12:"html.inc.tpl";b:1;s:15:"toolbar.inc.tpl";b:1;s:14:"header.inc.tpl";b:1;s:14:"footer.inc.tpl";b:1;}s:9:"timestamp";i:1467231396;s:7:"expires";i:1467234996;s:13:"cache_serials";a:0:{}}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li>
               ...
               <li >
                ...
                <li  class="active" ><a href="http://localhost/gp/public_html/signup.php">Register</a></li>
                ...
                <div class="form-group required">
                  ...
                  <div class="form-group required">
                     <div class="col-md-2">
                      ...
                      <div class="col-md-5">
                      <input type="password" name="pass" size="20" class="form-control" palceholder="password here ..." value=""  />(Must be at least 8 characters long)
                    </div>
                  </div>
                  <div class="form-group required">
                     <div class="col-md-2">
                      ...
                      <div class="col-md-5">
                      <input type="password" name="pass_confirm" size="20" class="form-control" palceholder="confirm password here ..." value=""  />(Must be at least 8 characters long)
                    </div>
                  </div>
                   <!-- dob -->
                  ...
                  <div class="form-group required">
                   ...
                   <div class="form-group required">
                    ...
                    <div class="col-sm-5 col-sm-offset-2 well"> 
                     ...
                     <img id="captcha" src="http://localhost/gp/public_html/captcha_image.php?x=1467231396" style="vertical-align: middle;border-radius:20px;border:2px solid grey;" alt="CAPTCHA Image" /> <i class="fa fa-2x fa-refresh" style="margin-left:10px;" onclick="CaptchaRefresh();"></i>
