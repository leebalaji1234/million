      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">Sponsor Management  &#8594; Sponsor Details </div>
            <div class="panel-body">
              <div class="row">
                <div class="col-lg-12"> 
                  ...
                  <!--    Context Classes  -->
                  <div class="panel panel-default">
                    <div class="panel-heading"> Sponsor Records </div>
                    <div class="panel-body">
...
if($total_results>0)
{
	?>
                          <thead>
                            <tr>
                              <th>Region Id</th>
                              <th>sponsor Company Name</th>
                              <th>sponsor URL</th>
                              <th>Sponsor Status</th>
                              <th>Sponsor Email Id</th>
                              <th>Edit</th>
                            </tr>
                          </thead>
                          <tbody>
...
if ($page <= 0)
	...
	?>
                            <tr>
                              ...
                              <td><a href="editsponsor.php?id=<?php echo mysql_result($result, $i, 'id');?>">Edit</a></td>
                            </tr>
                            <?php }  ?>
                            <tr>
                              <td colspan="12" align="right"><?php 
	 $reload = "allsponsor.php" . "?tpages=" . $tpages;
