      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading"> Entrant Management &#8594; Entrant Details </div>
            <div class="panel-body">
              <div class="row">
                <div class="col-lg-12"> 
                  ...
                  <!--    Context Classes  -->
                  <div class="panel panel-default">
                    <div class="panel-heading">  Entrant Records </div>
                    <div class="panel-body">
...
?>         
       ...
       <!-- <input type="text" name="ser" />-->
        <div class="form-group input-group">
                                            <input type="email" class="form-control" name="email" placeholder="Enter Entrant Email Id"  >
                                            <span class="input-group-btn">
                                               <button type="submit" class="btn btn-default"  name="submit" value="Search"  ><i class="fa fa-search"></i>
                                                </button>
                                            </span>
                                        </div>
    </form>
...
{
  $sql="SELECT * FROM mp_users where email='$email'";	
}
	...
	?>
                          <thead>
                            <tr>
                              <th>Entrants Id</th>
                              <th>Email Id</th>
                                <th>Entrants First Name</th>
                              <th>Entrants Last Name</th>
...
?></td>  
                              ...
                              <td><a href="editentrant.php?id=<?php echo mysql_result($result, $i, 'id');?>">Edit</a></td>
                            </tr>
                            <?php }  ?>
                            <tr>
                              <td colspan="12" align="right"><?php 
	 $reload = "allentrant.php" . "?tpages=" . $tpages;
