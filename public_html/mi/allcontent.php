      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading"> Content Management &#8594; Content Details </div>
            <div class="panel-body">
              <div class="row">
                <div class="col-lg-12"> 
                  ...
                  <!--    Context Classes  -->
                  <div class="panel panel-default">
                    <div class="panel-heading">  Content Records </div>
                    <div class="panel-body">
...
if ($page <= 0)
	...
	?>
                            <tr>
                              <td><?php echo mysql_result($result, $i, 'content_id');?></td>
                              <td><?php echo mysql_result($result, $i, 'content_name');?></td>
                              <td><?php echo mysql_result($result, $i, 'content_description');?></td>  
                              <td><?php echo mysql_result($result, $i, 'content_created_date');?></td>
                              <td><?php echo mysql_result($result, $i, 'last_updated_date_time');?></td>
                              <td><a href="editcontent.php?content_id=<?php echo mysql_result($result, $i, 'content_id');?>">Edit</a></td>
                            </tr>
                            <?php }  ?>
                            <tr>
                              <td colspan="12" align="right"><?php 
	 $reload = "allcontent.php" . "?tpages=" . $tpages;
