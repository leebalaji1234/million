...
<div class="row">
  <div class="form-group">
  	<div class="col-sm-6"> 
    <img width="200"  class="img-responsive" src="<?php echo ((is_array($_tmp=smarty_function_url(array('href' => 'images/instamojo.png'), $this))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));?>
